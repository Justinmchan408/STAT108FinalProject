...
# AIC
# 1 carlength, cylindernumber, drivewheel, enginesize, highwaympg, horsepower
# 2 carwidth, cylindernumber, drivewheel, enginesize, horsepower
# 3 cylindernumber, drivewheel, enginesize, horsepower, wheelbase
# 4 cylindernumber, drivewheel, enginesize, highwaympg, horsepower, wheelbase
# 5 carlength, cylindernumber, drivewheel, enginesize, horsepower
# BIC
# 1 carwidth, drivewheel, enginesize, horsepower
# 2 carwidth, cylindernumber, drivewheel, enginesize, horsepower
# 3 cylindernumber, drivewheel, enginesize, horsepower, wheelbase
# 4 carlength, cylindernumber, drivewheel, enginesize, horsepower
# 5 boreratio, carwidth, drivewheel, enginesize, horsepower
```

```{r anova table, echo= TRUE}
final.model <- lm(price ~ drivewheel+cylindernumber+carwidth+enginesize+horsepower, car_data)
...
l2 = ggplot(data = car_aug, aes(x = drivewheel, y = .resid)) +
  geom_boxplot() +
  geom_hline(yintercept = 0, color = "red") +
  labs(x = "Drive Wheel", y = "Residuals", title = "Residuals vs. Drive Wheel")

l3 = ggplot(data = car_aug, aes(x = cylindernumber, y = .resid)) +
  geom_boxplot() +
  geom_hline(yintercept = 0, color = "red") +
  labs(x = "Cylinder Number", y = "Residuals", title = "Residuals vs. Cylinder Number")

l4 = ggplot(data = car_aug, aes(x = carwidth, y = .resid)) +
  geom_point(alpha = 0.3) +
  geom_hline(yintercept = 0, color = "red") +
  labs(x = "Car Width", y = "Residuals", title = "Residuals vs. Car Width")
